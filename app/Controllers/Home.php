        ...
        if (isset($_GET['shop'])) {
            ...
            if (array_key_exists('errors', $response_home)) {
                ...
                if ($_GET['shop'] == 'desinomatetest.myshopify.com') {
                        ...
                        $get_register_webhook = $this->common->rest_api('admin/api/2023-07/recurring_application_charges/30826922288.json', array(), 'GET', $get_details->access_token, $_GET['shop']);
