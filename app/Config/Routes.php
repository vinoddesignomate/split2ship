...
$routes->match(['get', 'post'],'/samplfcsv', 'FrontController::samplfcsv');
...
$routes->match(['get', 'post'],'/frontend-get-handlingch', 'FrontController::get_handlincrg'); 
$routes->match(['get', 'post'],'/remove-web-hok', 'FrontController::removewebhookold');  
$routes->match(['get', 'post'],'/update-pro-test', 'AppwhookController::update_pro_test'); 
...
$routes->match(['get', 'post'],'/updatecartdata', 'AppwhookController::update_cart_webhook_data');
$routes->match(['get', 'post'],'/pro_create_evnt', 'AppwhookController::product_create_whok');
...
$routes->match(['get', 'post'],'/remove_older_coupon', 'FrontController::remove_partial_coupon'); //remove partially created coupon
$routes->match(['get', 'post'],'/creat_rem_partial_order', 'FrontController::create_double_order_cron');//create double order if webhook failed
