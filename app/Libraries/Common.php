...
class Common
{
    ...
    public function draft_order_creat2($token, $shopname, $final_array)
    {
        $curl = curl_init();
    ...
    public function create_fulfilmentorders($token, $shopname, $final_array)
    {
        $curl = curl_init();

        curl_setopt_array($curl, array(
            CURLOPT_URL => 'https://a47ead69b3d83a8042703f093f3cadb2:' . $token . '@' . $shopname . '/admin/api/2023-07/fulfillments.json',
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => '',
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 0,
