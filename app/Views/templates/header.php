        ...
        <div class="payxnowandrestondelivery-container">
            <div class="payxnowandrestondelivery-header-wrapper">
                ...
                <nav class="payxnowandrestondelivery-header-nav-links">
                    <ul>
                        <li><a onclick='abc(event);' class="<?php echo ($page_name == 'products-list') ? 'payxnowandrestondelivery-active' : '' ?> " href="https://admin.shopify.com/store/<?php echo esc($store_name); ?>/apps/pay-x-now-rest-on-delivery/payxnowandrestondelivery/products-list"><img src="/payxnowandrestondelivery/public/images/product.svg" class="payxnowandrestondelivery-hide-hover" alt="product-icon"><img src="/payxnowandrestondelivery/public/images/product-yellow.svg" class="payxnowandrestondelivery-on-hover" alt="product-icon">
Products</a></li>
                        <li><a onclick='abc(event);' class="<?php echo ($page_name == 'partial-products-list') ? 'payxnowandrestondelivery-active' : '' ?> " href="https://admin.shopify.com/store/<?php echo esc($store_name); ?>/apps/pay-x-now-rest-on-delivery/payxnowandrestondelivery/partial-products-list"><img src="/payxnowandrestondelivery/public/images/partial-prod.svg" class="payxnowandrestondelivery-hide-hover" alt="partial-prod-icon"><img src="/payxnowandrestondelivery/public/images/partial-product-yellow.svg" class="payxnowandrestondelivery-on-hover" alt="partial-prod-icon">
Partial Products List</a></li>
                        <li><a onclick='abc(event);' class="<?php echo ($page_name == 'show-orders') ? 'payxnowandrestondelivery-active' : '' ?> " href="https://admin.shopify.com/store/<?php echo esc($store_name); ?>/apps/pay-x-now-rest-on-delivery/payxnowandrestondelivery/show-orders"><img src="/payxnowandrestondelivery/public/images/orders.svg" class="payxnowandrestondelivery-hide-hover" alt="orders-icon"><img src="/payxnowandrestondelivery/public/images/order-yellow.svg" class="payxnowandrestondelivery-on-hover" alt="orders-icon">
Orders</a></li>
                        <li><a onclick='abc(event);' class="<?php echo ($page_name == 'price-plan') ? 'payxnowandrestondelivery-active' : '' ?> " href="https://admin.shopify.com/store/<?php echo esc($store_name); ?>/apps/pay-x-now-rest-on-delivery/payxnowandrestondelivery/price-plan"><img src="/payxnowandrestondelivery/public/images/pricing.svg" class="payxnowandrestondelivery-hide-hover" alt="pricing-icon"><img src="/payxnowandrestondelivery/public/images/pricing-yellow.svg" class="payxnowandrestondelivery-on-hover" alt="pricing-icon">
Pricing</a></li>
                        ...
                        <li><a onclick='abc(event);' class="<?php echo ($page_name == 'app-configuration') ? 'payxnowandrestondelivery-active' : '' ?> " href="https://admin.shopify.com/store/<?php echo esc($store_name); ?>/apps/pay-x-now-rest-on-delivery/payxnowandrestondelivery/app-configuration"><img src="/payxnowandrestondelivery/public/images/configuration.svg" alt="configuration-icon" class= "payxnowandrestondelivery-hide-hover"><img src="/payxnowandrestondelivery/public/images/configuration-yellow.svg" class="payxnowandrestondelivery-on-hover" alt="configuration-icon">Configuration</a></li>
                    </ul>
                </nav>
