             ...
             <div class="payxnowandrestondelivery-main-data-col">
                 ...
                 <?php
                    ...
                    if ($total_pages > 1) {
                        ...
                        if ($order_paging > 1) {
                            echo "<li><a onclick='abc(event)' href='https://admin.shopify.com/store/" . esc($store_namep) . "/apps/pay-x-now-rest-on-delivery/payxnowandrestondelivery/public/index.php/show-orders?order_paging=" . ($order_paging - 1) . "' class='payxnowandrestondelivery-button'>Previous</a></li>";
                        }
                        for ($i = 1; $i <= $total_pages; $i++) {
                            echo "<li><a onclick='abc(event)' href='https://admin.shopify.com/store/" . esc($store_namep) . "/apps/pay-x-now-rest-on-delivery/payxnowandrestondelivery/public/index.php/show-orders?order_paging=" . $i . "'>" . $i . "</a></li>";
                        };
                        if ($total_pages > $order_paging) {
                            echo "<li><a onclick='abc(event)' href='https://admin.shopify.com/store/" . esc($store_namep) . "/apps/pay-x-now-rest-on-delivery/payxnowandrestondelivery/public/index.php/show-orders?order_paging=" . ($order_paging + 1) . "' class='payxnowandrestondelivery-button'>Next</a></li>";
                        }
                        echo "</ul>";
                    }
                    ?>
