                    ...
                    <div class="payxnowandrestondelivery-inner-wrapper">
                        <div class="payxnowandrestondelivery-side-bar-col">
                            ...
                            <div class="payxnowandrestondelivery-flex-row payxnowandrestondelivery-image-row">
                                <div><img src="/payxnowandrestondelivery/public/images/delhivery-img.svg" alt="delhivery-icon"></div>
                                <div><img src="/payxnowandrestondelivery/public/images/pickrr.svg" alt="pickrr-icon"></div>
                                <div><img src="/payxnowandrestondelivery/public/images/shiprocket.svg" alt="shiprocket-icon"></div>
                            </div>
                        </div>
                        <div class="payxnowandrestondelivery-main-data-col">
                            <div class="payxnowandrestondelivery-head-wrapper">
