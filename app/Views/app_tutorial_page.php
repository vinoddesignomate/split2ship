            ...
            <div>
                ...
                {% capture email_title %}
                                ...
                                <table>
                                        ...
                                        <span class="order-list__item-title">{{ line_title }} {% if line.properties.Note == 'Initial Partial Payment'%}<br/><span style="color:red;">Partial Amount={{line.properties.partial_pay}}</span><br/><span style="color:red;">Pending Amount={{line.properties.remaining_amount}}</span><br/>{% endif %}  × {{ line_display }}</span>
