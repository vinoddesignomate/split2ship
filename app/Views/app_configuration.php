...
<div class="payxnowandrestondelivery-whiteAreaDiv payxnowandrestondelivery-container">
        ...
        <div class=" payxnowandrestondelivery-main-area ">
                ...
                <div class="payxnowandrestondelivery-imgIns"><img src="/payxnowandrestondelivery/public/images/instruct/config1.jpg" /></div>
        </div>
        <div class=" payxnowandrestondelivery-main-area ">
                <h5><b class="text-orange">Step 2:</b> click on “Customize” the theme.</h5>

                <div class="payxnowandrestondelivery-imgIns"><img src="/payxnowandrestondelivery/public/images/instruct/config2.jpg" /></div>
        </div>
        <div class=" payxnowandrestondelivery-main-area ">
                <h5><b class="text-orange">Step 3:</b> Select default product under product drop down.</h5>

                <div class="payxnowandrestondelivery-imgIns"><img src="/payxnowandrestondelivery/public/images/instruct/config3.jpg" /></div>
        </div>
        <div class="payxnowandrestondelivery-main-area-row">
                <div class=" payxnowandrestondelivery-main-area ">
                        ...
                        <div class="payxnowandrestondelivery-imgIns"><img src="/payxnowandrestondelivery/public/images/instruct/app-embed.png?var=1" /></div>
                </div>
                <div class=" payxnowandrestondelivery-main-area ">
                        <h5><b class="text-orange">Step 5:</b> Add section where you want to show partial and full pay.</h5>

                        <div class="payxnowandrestondelivery-imgIns"><img src="/payxnowandrestondelivery/public/images/instruct/step-5.png?var=2" /></div>
                </div>
        </div>
        <div class=" payxnowandrestondelivery-main-area ">
                <h5><b class="text-orange">Step 6:</b> App section will show like this.</h5>

                <div class="payxnowandrestondelivery-imgIns"><img src="/payxnowandrestondelivery/public/images/instruct/config6.jpg?var=3" /></div>
        </div>
        <div class="payxnowandrestondelivery-main-area-row ">
                <div class="payxnowandrestondelivery-main-area ">
